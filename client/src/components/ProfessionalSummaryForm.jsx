...
function ProfessionalSummaryForm({data , onChange , setResumeData}) {
  return (
    <div className='space-y-4'>
      ...
      <div className='mt-6'>
        <textarea value={data || ""} onChange={(e)=>onChange(e.target.value)} rows={7} className="w-full px-4 mt-2 border text-m border-gray-300 rounded-lg focus:ring focus:ring-blue-500
        ...
        <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'>Tip: Keep it concise (3-4 sentences) and focus on your most relevent
