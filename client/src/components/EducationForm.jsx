                ...
                {data.map((education , index)=>(
                    ...
                    rounded-lg space-y-3' >
                          ...
                          <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            onChange={(e)=>updateEducation(index , "institution",e.target.value)} type='text' placeholder='Institution Name'
                            ...
                            onChange={(e)=>updateEducation(index , "field",e.target.value)} type='text'  placeholder='Field of Study'
                            className='px-3 py-3 text-sm ' />
                            </div>
                             <div className='grid md:grid-cols-2 gap-3'>
                   ...
                   <div className='grid md:grid-cols-2 gap-3'>
                            <input value={education.gap || ""} 
                            onChange={(e)=>updateEducation(index , "gap",e.target.value)} type='text'  placeholder='GPA (optional)'
                            className='px-3 py-3 text-sm ' />
                            </div>
                    </div>
                ))}
