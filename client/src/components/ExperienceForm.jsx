                ...
                {data.map((experience , index)=>(
                    ...
                    rounded-lg space-y-3' >
                          ...
                          <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            onChange={(e)=>updateExperience(index , "end_date",e.target.value)} type='month' disabled={experience.is_current}
                            ...
                            <div className='space-y-2'>
                                ...
                                <textarea value={experience.description || ""}
                                 onChange={(e)=> updateExperience(index, "description",e.target.value)} rows={4} className='w-full text-sm px-3 py-2 rounded-lg resize-none'
