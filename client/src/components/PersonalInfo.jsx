...
function PersonalInfo({data , onChange,removeBackground,setRemoveBackground}) {
  ...
  return (
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            {data.image ? (<img src={typeof data.image === 'string' ? data.image : URL.createObjectURL(data.image)} alt='user-image'  className='w-16
            h-16 rounded-full object-cover mt-5 ring ring-slate-300'/> ):(
        ...
        {fields.map((field)=>{
          ...
          return (
            <div key={field.key} className='space-y-1 mt-5'>
              ...
              mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring
